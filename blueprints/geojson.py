...
BLOB_NAME_GIS = "outputgisv6.geojson"          # Replace with your blob name
...
def get_geojson():
    ...
    try:
        ...
        # Get the BlobClient
        blob_client = blob_service_client.get_blob_client(
            container=CONTAINER_NAME, blob=BLOB_NAME_GIS)
        logger.info(
            f"BlobClient for container '{CONTAINER_NAME}'"
            + f" and blob '{BLOB_NAME_GIS}' obtained successfully.")
